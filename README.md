...
values of the predictors $P$. If using the predictions for decision
making, according to the naive model, no patient should be treated, as
patients that get treated have a higher risk for the outcome. The causal
model, however, correctly infers that treatment benefits patients (as
the coefficient for $A$ is negative).
