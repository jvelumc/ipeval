...
## Installation 
You can install the development version of ipeval from [GitHub](https://github.com/) with:
``` r
...
$ip_score()$ also supports stabilized weights and bootstrapping for confidence intervals.
