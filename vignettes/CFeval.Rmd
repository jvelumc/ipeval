...
We then set censoring method to "cox", and supply the formula needed for the censoring model as the right hand side of cens_formula. Internally, the censoring distribution is estimated with this expression, from which the inverse probability of **censoring** weights are computed, which are then combined with the inverse probability of **treatment** weights. These combined weights are used to represent a population in which every patient was treated and remained uncensored.
